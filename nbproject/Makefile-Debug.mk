...
${OBJECTDIR}/AdminCli.o: AdminCli.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminCli.o AdminCli.cpp

${OBJECTDIR}/AdminGuia.o: AdminGuia.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminGuia.o AdminGuia.cpp

${OBJECTDIR}/AdminReser.o: AdminReser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminReser.o AdminReser.cpp

${OBJECTDIR}/AdminRutas.o: AdminRutas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminRutas.o AdminRutas.cpp

${OBJECTDIR}/AdminTripu.o: AdminTripu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminTripu.o AdminTripu.cpp

${OBJECTDIR}/AdminVuelo.o: AdminVuelo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminVuelo.o AdminVuelo.cpp

${OBJECTDIR}/AgenciaDeViajes.o: AgenciaDeViajes.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AgenciaDeViajes.o AgenciaDeViajes.cpp
...
${OBJECTDIR}/ContenedoraAvion.o: ContenedoraAvion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContenedoraAvion.o ContenedoraAvion.cpp
...
${OBJECTDIR}/Guia.o: Guia.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Guia.o Guia.cpp

${OBJECTDIR}/Hora.o: Hora.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hora.o Hora.cpp
...
${OBJECTDIR}/ListaReser.o: ListaReser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaReser.o ListaReser.cpp

${OBJECTDIR}/ListaTripulante.o: ListaTripulante.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaTripulante.o ListaTripulante.cpp

${OBJECTDIR}/NodoReser.o: NodoReser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodoReser.o NodoReser.cpp

${OBJECTDIR}/NodoTripulante.o: NodoTripulante.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodoTripulante.o NodoTripulante.cpp
...
${OBJECTDIR}/Reservacion.o: Reservacion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Reservacion.o Reservacion.cpp

${OBJECTDIR}/Ruta.o: Ruta.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ruta.o Ruta.cpp

${OBJECTDIR}/Tripulante.o: Tripulante.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tripulante.o Tripulante.cpp
